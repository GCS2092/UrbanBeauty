...
export default function Checkout() {
  ...
  const { register, handleSubmit, setValue, watch, formState: { errors } } = useForm({
    ...
    defaultValues: { paymentMethod: 'CASH_ON_DELIVERY', country: 'Sénégal' },
  });
  ...
  const handleValidateCoupon = async () => {
    ...
    try {
      ...
      setCoupon(data);
      toast.success(`Coupon appliqué : -${data.type === 'PERCENTAGE' ? data.value + '%' : formatPrice(data.value)}`);
    } catch (err) {
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-stone-100 p-5 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <Input label="Téléphone" placeholder="+221 77 000 00 00" error={errors.phone?.message} {...register('phone')} />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <Input label="Pays" placeholder="Sénégal" error={errors.country?.message} {...register('country')} />
            </div>
            <div>
