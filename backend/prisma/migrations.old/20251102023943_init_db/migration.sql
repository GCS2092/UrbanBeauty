-- CreateEnum
CREATE TYPE "Role" AS ENUM ('CLIENT', 'COIFFEUSE', 'VENDEUSE', 'ADMIN');

-- CreateEnum
CREATE TYPE "ImageType" AS ENUM ('UPLOADED', 'URL');
...
-- AddForeignKey
ALTER TABLE "Service" ADD CONSTRAINT "Service_providerId_fkey" FOREIGN KEY ("providerId") REFERENCES "Profile"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Image" ADD CONSTRAINT "Image_portfolioId_fkey" FOREIGN KEY ("portfolioId") REFERENCES "Profile"("id") ON DELETE SET NULL ON UPDATE CASCADE;
